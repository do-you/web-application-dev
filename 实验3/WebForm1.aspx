<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="实验3.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ValidationSummary runat="server" ShowMessageBox="True" DisplayMode="List" ShowSummary="False" HeaderText="dsdgfdg"></asp:ValidationSummary>
        </div>
    </form>
</body>
</html>
